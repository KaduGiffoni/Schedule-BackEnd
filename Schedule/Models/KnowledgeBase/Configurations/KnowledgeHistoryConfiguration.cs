    ...
    public class KnowledgeHistoryConfiguration : IEntityTypeConfiguration<KnowledgeHistory>
    {
        public void Configure(EntityTypeBuilder<KnowledgeHistory> builder)
        {
            ...
            builder.HasOne(x => x.Article)
                .WithMany() // Pode ser .WithMany(a => a.AuditLogs) se a coleção estiver exposta na raiz do artigo
            ...
            builder.HasOne(x => x.User)
                ...
                .OnDelete(DeleteBehavior.Restrict); // CRÍTICO: Se um utilizador for apagado, os registos das ações históricas que ele tomou permanecem intactos.
        }
    }
}