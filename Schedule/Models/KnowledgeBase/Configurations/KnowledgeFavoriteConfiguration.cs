    ...
    public class KnowledgeFavoriteConfiguration : IEntityTypeConfiguration<KnowledgeFavorite>
    {
        public void Configure(EntityTypeBuilder<KnowledgeFavorite> builder)
        {
            ...
            builder.HasOne(x => x.Article)
                .WithMany(a => a.Favorites) // Se descomentou a coleção na entidade KnowledgeArticle
            ...
            builder.HasOne(x => x.User)
                ...
                .OnDelete(DeleteBehavior.Cascade); // Se o utilizador for despedido e apagado do sistema, limpamos os seus favoritos.
        }
    }
}